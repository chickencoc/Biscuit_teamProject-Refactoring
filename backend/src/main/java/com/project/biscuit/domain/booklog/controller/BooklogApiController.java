package com.project.biscuit.domain.booklog.controller;

import com.project.biscuit.domain.booklog.dto.*;
...
import com.project.biscuit.domain.booklog.service.BooklogService;
...
public class BooklogApiController {
    ...
    public ResponseEntity<List<Book>> findBooksAll() {
        List<Book> books = booklogArticleService.findBooksAll();
    ...
    public ResponseEntity<List<Book>> searchBooksByTitle(@RequestParam String title) {
        List<Book> books = booklogArticleService.searchBooksByTitle(title);
        return ResponseEntity.ok()
                .body(books);
    }
