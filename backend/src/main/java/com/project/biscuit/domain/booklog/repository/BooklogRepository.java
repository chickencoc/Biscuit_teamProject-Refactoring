package com.project.biscuit.domain.booklog.repository;

import com.project.biscuit.domain.booklog.entity.Booklog;
import com.project.biscuit.domain.booklog.dto.BooklogArticleWithBooklogInfo;
...
public interface BooklogRepository extends JpaRepository<Booklog, Long> {
    ...
    @Query("SELECT new com.project.biscuit.domain.booklog.dto.BooklogArticleWithBooklogInfo(a, b) " +
