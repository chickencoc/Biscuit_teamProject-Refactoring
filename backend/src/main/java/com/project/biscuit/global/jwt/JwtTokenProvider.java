package com.project.biscuit.global.jwt;

import com.project.biscuit.domain.user.dto.JwtTokenDto;
...
public class JwtTokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24;    // 24시간의 유효기간
    ...
    public JwtTokenDto generateTokenDto(String id) {
        ...
        String accessToken = Jwts.builder()
                ...
                .setSubject(id)
                // 현재는 ROLE_USER만 가져옴
                .claim(AUTHORITIES_KEY, Authority.U)
